...
var api = {
        ...
        // Our headerpullView for other devices
            ...
            if (parameters.headerPullView) {
                ...
                if (parameters.headerPullView.view) {
                    api.headerPullViewSize = parameters.headerPullView.view.size ? parameters.headerPullView.view.size : 0;
                }
            }
    ...
    showScroll: function() {
    	api.headerPullView.height = 60;
    	api.headerPullView.show();
    },
