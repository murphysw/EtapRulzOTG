...
// in simulator we redefine to format for Cornerstone Developer console
...
{\
	NSString * exceptionName = [@"org.cornerstone." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cornerstone";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICornerstoneNativeItemNone = -1, 
	UICornerstoneNativeItemSpinner = -2,
	UICornerstoneNativeItemProgressBar = -3,
	
	UICornerstoneNativeItemSlider = -4,
	UICornerstoneNativeItemSwitch = -5,
	UICornerstoneNativeItemMultiButton = -6,
	UICornerstoneNativeItemSegmented = -7,
	
	UICornerstoneNativeItemTextView = -8,
	UICornerstoneNativeItemTextField = -9,
	UICornerstoneNativeItemSearchBar = -10,
	
	UICornerstoneNativeItemPicker = -11,
	UICornerstoneNativeItemDatePicker = -12,
	
	UICornerstoneNativeItemInfoLight = -13,
	UICornerstoneNativeItemInfoDark = -14,
	
	UICornerstoneNativeItemDisclosure = -15,
	
	UICornerstoneNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Cornerstone instances of
