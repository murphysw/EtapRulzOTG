...
/**
 Base class for all Cornerstone views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Cornerstone view hierarchy (such as wrapped iOS UIViews) was touched.
