...
@interface CornerstoneObject : KrollCoverageObject {
#else
@interface CornerstoneObject : KrollObject {
#endif
@private
...
extern NSString * Cornerstone$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CornerstoneObject *_cornerstone;
    KrollObject* console;
	BOOL shutdown;
