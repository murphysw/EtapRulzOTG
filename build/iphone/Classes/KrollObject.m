...
//@interface CornerstoneObject : NSObject
//@end

@interface CornerstoneObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CornerstoneObject class]])
		{
			for (NSString *key in [[(CornerstoneObject*)o modules] allKeys])
			{
